...
<HTML xmlns="http://www.w3.org/1999/xhtml">
	...
	<BODY>
		<FORM id=form1 name=form1 action="<%=request.getContextPath()%>/user_login.action" method=post target="_parent">
			<DIV id=UpdatePanel1>
													...
													<TABLE cellSpacing=0 cellPadding=2 border=0>
														<TBODY>
															...
															<TR>
																<TD></TD>
																<TD>
																	<INPUT id=btn style="BORDER-TOP-WIDTH: 0px; BORDER-LEFT-WIDTH: 0px; BORDER-BOTTOM-WIDTH: 0px; BORDER-RIGHT-WIDTH: 0px" onclick='javascript:WebForm_DoPostBackWithOptions(new WebForm_PostBackOptions("btn", "", true, "", "", false, false))' type=image src="images/login_button.gif" name=btn>
																</TD>
															</TR>
														</TBODY>
													</TABLE>
