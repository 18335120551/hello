								...
								<TR>
									<TD>
										<TABLE id=table_1 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="<%=request.getContextPath()%>/customer_saveUI.action" 
														target=main>－ 新增客户</A></TD>
												</TR>
												<TR> 
													<TD class=menuSmall><A class=style2 href="<%=request.getContextPath()%>/customer_findAll.action"
